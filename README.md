...
[![Version](https://img.shields.io/badge/Version-v3.8.0-blue?style=for-the-badge)](releases/flipclock-screensaver_3.8.0.deb)
...
[![Archived Release v3.8.0](https://img.shields.io/badge/Archive-v3.8.0.deb-6366F1?style=for-the-badge&logo=debian&logoColor=white)](https://raw.githubusercontent.com/smit-darji/ubuntu-flipclock-screensaver/Master/releases/flipclock-screensaver_3.8.0.deb)
...
#### Option B: Install Versioned Release Archive (`v3.8.0`)
```bash
# 1. Download version v3.8.0 from the releases/ directory
wget https://raw.githubusercontent.com/smit-darji/ubuntu-flipclock-screensaver/Master/releases/flipclock-screensaver_3.8.0.deb

# 2. Install versioned package via apt
sudo apt update
sudo apt install ./flipclock-screensaver_3.8.0.deb
```
