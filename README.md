...
[![Version](https://img.shields.io/badge/Version-v5.1.0-blue?style=for-the-badge)](releases/flipclock-screensaver_5.1.0.deb)
...
[![Archived Release v5.0.2](https://img.shields.io/badge/Archive-v5.1.0.deb-6366F1?style=for-the-badge&logo=debian&logoColor=white)](https://raw.githubusercontent.com/smit-darji/ubuntu-flipclock-screensaver/Master/releases/flipclock-screensaver_5.1.0.deb)
...
## ✨ New in v5.1.0: Frameless 3D Glass Live Clock Overlay & Animated WebP/WebM Wallpapers

Experience the brand new **v5.1.0 Release** featuring:
...
<p align="center">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;
  <a href="https://raw.githubusercontent.com/smit-darji/ubuntu-flipclock-screensaver/Master/releases/flipclock-screensaver_5.1.0.deb" target="_blank">
...
wget https://raw.githubusercontent.com/smit-darji/ubuntu-flipclock-screensaver/Master/releases/flipclock-screensaver_5.1.0.deb

# 2. Install versioned package via apt
sudo apt update
sudo apt install ./flipclock-screensaver_5.1.0.deb
```
...
./build_deb.sh
```
This generates `flipclock-screensaver.deb` (and `flipclock-screensaver_5.1.0.deb`) in the `releases/` directory.
