...
[![Version](https://img.shields.io/badge/Version-v2.9.0-blue?style=for-the-badge)](releases/flipclock-screensaver_2.9.0.deb)
...
[![Archived Release v2.9.0](https://img.shields.io/badge/Archive-v2.9.0.deb-6366F1?style=for-the-badge&logo=debian&logoColor=white)](https://raw.githubusercontent.com/smit-darji/ubuntu-flipclock-screensaver/Master/releases/flipclock-screensaver_2.9.0.deb)
...
## ✨ New in v2.9.0: Ganesha Festival Divine Gold Theme & Fluid Responsive Layout

Experience the brand new **Ganesha Festival Divine Gold** theme (`glass_ganesha`) featuring divine saffron & marigold ambient lighting, plus fluid responsive code-based layout scaling across all 8 Glass Clock themes (`glass_clock`, `glass_aurora`, `glass_cyberpunk`, `glass_emerald`, `glass_sunset`, `glass_spiderman`, `glass_ganesha`, `glass_minimal_oled`).
...
<p align="center">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;
  <a href="https://raw.githubusercontent.com/smit-darji/ubuntu-flipclock-screensaver/Master/releases/flipclock-screensaver_2.9.0.deb" target="_blank">
    <img src="https://img.shields.io/badge/DOWNLOAD-Versioned%20v2.9.0%20.deb-6366F1?style=for-the-badge&logo=debian&logoColor=white" height="48" alt="Download Versioned .deb Package">
  </a>
  &nbsp;&nbsp;&nbsp;&nbsp;
...
#### Option B: Install Versioned Release Archive (`v2.9.0`)
```bash
# 1. Download version v2.9.0 from the releases/ directory
wget https://raw.githubusercontent.com/smit-darji/ubuntu-flipclock-screensaver/Master/releases/flipclock-screensaver_2.9.0.deb

# 2. Install versioned package via apt
sudo apt update
sudo apt install ./flipclock-screensaver_2.9.0.deb
```
